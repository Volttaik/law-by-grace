...
const CONTENT: Record<Purpose, EmailContent> = {
  signup: {
    icon: "⚖️",
    title: "Welcome to Law by Grace",
    subtitle: "Finish setting up your account",
    body: "Thanks for joining Law by Grace — a calm, beautiful e-library for law. To protect your account and make sure we have the right email address, we need to verify it before activating your profile.",
    ...
    urgency: "This code is valid for <strong>10 minutes</strong> and can only be used once. If you did not create a Law by Grace account, you can safely ignore this email — no account will be created.",
  },
  password_reset: {
    icon: "🔑",
    title: "Password reset request",
    subtitle: "We received a request to reset your password",
    body: "We received a request to reset the password associated with your Law by Grace account. If this was you, use the verification code below to proceed. If you did not make this request, your account is still secure — simply disregard this message.",
  ...
  bank_account: {
    ...
    body: "A security-sensitive action was requested on your Law by Grace account. To complete it securely, enter the verification code below.",
  ...
  verify_account: {
    ...
    subtitle: "Complete your Law by Grace account setup",
    body: "Before you can sign in to Law by Grace, we need to confirm that this email address belongs to you. This is a standard security step that helps us keep your account safe and ensures you can recover access if needed.",
    ...
    urgency: "This code expires in <strong>10 minutes</strong>. If you did not create a Law by Grace account using this email address, you can safely ignore this email.",
  },
  delete_course: {
    icon: "⚠️",
    title: "Confirm course deletion",
    subtitle: "This action is permanent and cannot be undone",
    body: "You've requested to permanently delete a course from Law by Grace. Deleting a course will remove all associated materials, uploaded files, reading progress, and quiz data. This action cannot be reversed once confirmed.",
...
Never share this code with anyone. Law by Grace staff will never ask for your verification code.

${"=".repeat(60)}
This email was sent to ${recipientEmail} because an action was performed on a Law by Grace account associated with this address.

Law by Grace – Legal E-Library & Study Platform
If you have questions, reply to this email or visit https://lawbygrace.app

© ${year} Law by Grace. All rights reserved.
You received this transactional email as part of your use of the Law by Grace platform.`;
}
...
<head>
  ...
  <title>${c.title} – Law by Grace</title>
  <!--[if mso]>
              ...
              <table role="presentation" cellpadding="0" cellspacing="0">
                <tr>
                  <td style="background:linear-gradient(135deg,#1e3a8a 0%,#1d4ed8 55%,#2563eb 100%);border-radius:14px;padding:12px 22px;">
                    <span style="font-family:Georgia,'Times New Roman',serif;font-size:17px;font-weight:700;color:#ffffff;letter-spacing:-0.2px;">Law by Grace</span>
                  </td>
                </tr>
              </table>
            </td>
                    ...
                    <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="margin-top:24px;">
                      <tr>
                        <td style="background-color:#f8fafc;border-radius:12px;padding:16px 20px;">
                          ...
                          <p style="margin:0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Arial,sans-serif;font-size:13px;color:#64748b;line-height:1.6;">Never share this code with anyone — including people claiming to be from Law by Grace. Our team will <strong>never</strong> ask for your verification code via email, chat, or phone.</p>
                        </td>
                      </tr>
                    </table>
          ...
          <tr>
            <td style="padding:28px 8px 12px;">
              <p style="margin:0 0 8px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Arial,sans-serif;font-size:12px;color:#64748b;text-align:center;line-height:1.7;">
                This email was sent to <strong style="color:#334155;">${recipientEmail}</strong> because an action was requested on a Law by Grace account associated with this address.
              </p>
              <p style="margin:0 0 8px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Arial,sans-serif;font-size:12px;color:#64748b;text-align:center;line-height:1.7;">
              ...
              <p style="margin:0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Arial,sans-serif;font-size:11px;color:#94a3b8;text-align:center;line-height:1.6;">
                © ${year} Law by Grace. All rights reserved. &nbsp;·&nbsp; Legal E-Library &amp; Study Platform<br />
                <span style="font-size:10px;color:#b6c2d4;">Law by Grace · lawbygrace.app</span>
              </p>
            </td>
          </tr>
...
export async function sendVerificationCode(
  ...
  if (!isEmailConfigured()) {
    console.log(
      `\n[Law by Grace · DEV EMAIL — no provider configured]` +
        `\n  To: ${email}` +
